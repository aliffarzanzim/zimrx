...
class ZimRxIcon {
    private static array $icons = [
        ...
        'scale' => '<rect x="3" y="3" width="18" height="18" rx="3"></rect><circle cx="12" cy="8.5" r="2.5"></circle><line x1="12" y1="8.5" x2="13.2" y2="7.2"></line><line x1="7" y1="16" x2="17" y2="16"></line>',
        'weight' => '<rect x="3" y="3" width="18" height="18" rx="3"></rect><circle cx="12" cy="8.5" r="2.5"></circle><line x1="12" y1="8.5" x2="13.2" y2="7.2"></line><line x1="7" y1="16" x2="17" y2="16"></line>',
        'ruler' => '<rect x="7" y="2" width="10" height="20" rx="1.5"></rect><line x1="12" y1="6" x2="17" y2="6"></line><line x1="10" y1="10" x2="17" y2="10"></line><line x1="12" y1="14" x2="17" y2="14"></line><line x1="10" y1="18" x2="17" y2="18"></line>',
        'height' => '<rect x="7" y="2" width="10" height="20" rx="1.5"></rect><line x1="12" y1="6" x2="17" y2="6"></line><line x1="10" y1="10" x2="17" y2="10"></line><line x1="12" y1="14" x2="17" y2="14"></line><line x1="10" y1="18" x2="17" y2="18"></line>',
        'pill' => '<path d="M10.5 20.5l10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"></path><path d="m8.5 8.5 7 7"></path>',
    ...
    public static function svg(string $name, int $size = 14, array $attrs = []): string {
        ...
        $content = self::$icons[$key] ?? self::$icons['hash'];

        $strokeWidth = $attrs['stroke-width'] ?? '2';
        $class = $attrs['class'] ?? 'zrx-icon';
        $color = $attrs['color'] ?? 'currentColor';

        return sprintf(
            '<svg class="%s" width="%d" height="%d" viewBox="0 0 24 24" fill="none" stroke="%s" stroke-width="%s" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">%s</svg>',
            htmlspecialchars($class),
            $size,
            $size,
            htmlspecialchars($color),
            htmlspecialchars((string)$strokeWidth),
            $content
        );
    }
...
function zrx_icon(string $name, int $size = 14, array $attrs = []): string {
    return ZimRxIcon::svg($name, $size, $attrs);
}
